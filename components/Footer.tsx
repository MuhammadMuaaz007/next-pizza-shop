          ...
          <div className='grid items-center gap-8 md:gap-12 lg:grid-cols-2'>
            ...
            <div className='w-full'>
              ...
              <input
                ...
                className='h-12 w-full flex-1 rounded-2xl border border-gray-300 bg-white px-4 text-base text-gray-900 placeholder:text-gray-500 shadow-sm focus:border-orange-500 focus:ring-orange-500/20 md:h-14 md:px-6 md:text-lg'
              />
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12'>
          ...
          <div className='lg:col-span-2 space-y-4 md:space-y-6 text-center md:text-left'>
            <div className='flex items-center justify-center md:justify-start space-x-3'>
              <div className='w-10 h-10 md:w-12 md:h-12 bg-linear-to-br from-red-500 via-orange-500 to-yellow-500 rounded-2xl flex items-center justify-center'>
